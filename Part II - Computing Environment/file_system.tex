...
\chapter{Managing Your Local File System on Windows and macOS}
\label{ch:filesystem}
...
\begin{itemize}
\item \textbf{Windows:} drive letters and fully-qualified paths like \texttt{C:\textbackslash Users\textbackslash name\textbackslash Documents}; also network (UNC) paths like \texttt{\server\textbackslash share}.
