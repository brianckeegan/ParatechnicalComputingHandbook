...
## 3. What the AI was *not* asked to do
...
## 5. What we got wrong, and what we watched for
...
## 6. What this means for students using the book
...
## 7. Discussion: why we disclose at all
...
If this book grows to include executable code cells (see @sec-jupyter) or tests (see @sec-testing) that ship with the book itself, the same standard will apply to them: AI may draft, humans verify and take responsibility.

## 9. How we will keep this appendix current
...
## 11. Checklist for your own work
