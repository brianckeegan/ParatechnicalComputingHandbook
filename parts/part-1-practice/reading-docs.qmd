...
## 1. The four genres of documentation
...
## 4. Reading docstrings from Python itself
...
## 5. Reading a docstring: the canonical shape
...
## 6. Extracting a minimal example from the docs
