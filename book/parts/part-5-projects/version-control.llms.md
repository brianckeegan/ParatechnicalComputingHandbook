...
## 25.1 Mental models and vocabulary
...
## 25.2 Why version control matters for student data work
...
## 25.3 Getting started: create or clone
...
## 25.4 Daily Git workflow (the minimum viable loop)
...
## 25.5 Branches and merges (collaboration without chaos)
...
## 25.8 Forking workflow (contributing without direct write access)
...
## 25.9 Merge conflicts: a disciplined resolution playbook
...
## 25.10 Special considerations for data science projects
...
## 25.15 Quick reference: common commands (student set)
