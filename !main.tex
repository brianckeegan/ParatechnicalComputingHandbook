...
% Full-width verbatim code blocks for tufte-book
\usepackage{fvextra}   % extends fancyvrb; enables wrapping, etc.
% \usepackage{etoolbox}  % environment hooks

% Define a verbatim environment whose delimiter is \end{fullcode}
