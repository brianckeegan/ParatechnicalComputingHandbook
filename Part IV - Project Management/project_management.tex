\part{Part IV - Project Management}
% LaTeX Canvas: Chapter Outline
\chapter{Project Management for Data Work: Reproducible Structure, Data Hygiene, Documentation, and Issue Tracking}
...
\item Avoid spaces and ambiguous names (\texttt{final_final2.csv}).
\end{itemize}
