...
\chapter{Collaboration Mechanics: Documentation, Code Review, Commenting, and Shared Workflows}
...
\item \texttt{CODE_OF_CONDUCT.md} (when appropriate): norms and escalation.
