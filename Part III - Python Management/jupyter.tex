...
\chapter{Jupyter Notebook and JupyterLab Fundamentals}
\label{ch:jupyter}
...
\item Create a small marker file (e.g., \texttt{PROJECT_ROOT.txt}) so you can tell when you are in the right place.
\end{itemize}
