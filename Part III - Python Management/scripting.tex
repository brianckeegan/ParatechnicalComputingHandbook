...
\chapter{Scripts and Notebooks: Writing Reusable Code, Passing Parameters, and Choosing the Right Medium}
...
\item[Package] A directory of modules (typically with \texttt{__init__.py}) installed or importable.
\end{description}
...
\item \texttt{if __name__ == "__main__":} block
\end{itemize}
...
\begin{itemize}
\item Create \texttt{scripts/run_cleaning.py}.
