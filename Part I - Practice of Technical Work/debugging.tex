...
\begin{itemize}[noitemsep]
  ...
  \item \textbf{Imports and environments}: \texttt{ModuleNotFoundError}, version conflicts.
\end{itemize}
...
Some ``code'' bugs are actually environment bugs:
\begin{itemize}[noitemsep]
...
\paragraph{Experiment.} Run the script from the project root, or change the script to compute absolute paths based on \texttt{__file__}.
